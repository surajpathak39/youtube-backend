...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // console.log(isPasswordValid, 12999);
  if (!isPasswordValid) {
  ...
  console.log(loggedInUser, 143333);
